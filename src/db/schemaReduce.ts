...
// import type { items_DTYPE, enum_DTYPE } from '@/types/db/schemaReduce'
...
// export function reduceProp(...args): JSONSchema {
...
// // 复用数组
// export function arrRepeta(arr: createProp_param, n1, n2) {
//   const _arr = [...arr]
//   _arr[1] = n1
//   _arr[2] = n2
//   return _arr
...
//       const { desc, type, n1, n2, len, required } = entity[key]
//       let n2Val = n2
//       if (len > 0 && n2 === 'max') {
...
//     keys.forEach((key: keyof T) => {
//       const schema = this.clone(this.entity[key].schema) as createProp_param
//       list.push(schema)
//     })
//     this.appendVoKeys.forEach((key: keyof entity_DTYPE) => {
//       const schema = this.clone(this.appendVo[key].schema) as createProp_param
//       list.push(schema)
//     })
